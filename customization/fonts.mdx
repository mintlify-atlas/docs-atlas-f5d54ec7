...
VT323 is a monospace terminal typeface modeled on the character ROM of vintage CRT monitors. In Old Windows it is used exclusively for the LED visitor counter digits displayed on the desktop, where its angular, dot-matrix character shapes sell the illusion of a hardware counter.
