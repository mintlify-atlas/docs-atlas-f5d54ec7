---
title: "Desktop: The Root Canvas of Old Windows"
sidebarTitle: "Desktop"
description: "The Desktop component is the outermost UI shell of Old Windows. It renders the teal canvas, desktop icons, visitor counter, CRT effects, and the Taskbar."
---
...
These are `pointer-events-none` and do not interfere with interaction.
